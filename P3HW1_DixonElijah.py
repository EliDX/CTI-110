...
# 10/19/2024
# P3HW1
# Making a program that will take information inputted by a user, store that info in a list, and use the list to return useful information on said data.
...
# Adding an if/else statement to let the user know what their letter grade is!

if AvgGrd >= 90:
    LGrade = "A"
    if AvgGrd == 100:
        print(f"Woah! A 100%!? Thats AMAZING!")
    else:
        print("Good Job!")
