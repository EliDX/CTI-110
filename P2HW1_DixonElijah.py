...
# These are the leftovers from P1HW2, I kept them for reference
'''
print("")
...
print(f"{'Accomodation:':<20}${accomodations:,.2f}")
print(f"{'Food:':<20}${food:,.2f}")

print("_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_")
print()
print(f"{'Money to be spent:':<20}${total:,.2f}")
print(f"{'Remaining Balance:':<20}${fbudget:,.2f}")
print()
